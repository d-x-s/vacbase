...
//	private static final String ORACLE_URL = "jdbc:oracle:thin:@dbhost.students.cs.ubc.ca:1522:stu";
    ...
    private void createTriggers() {
        try {
            ...
            stmt.executeQuery("CREATE OR REPLACE TRIGGER account_creation_trigger BEFORE INSERT ON PatientAccount FOR EACH ROW DECLARE v_username varchar2(100); BEGIN SELECT user INTO v_username FROM dual; INSERT INTO ActivityLog (Username, Activity, TimeOf) VALUES (v_username, 'CREATION', SYSTIMESTAMP); END;");
            stmt.executeQuery("CREATE OR REPLACE TRIGGER account_deletion_trigger AFTER DELETE ON PatientAccount FOR EACH ROW DECLARE v_username varchar2(100); BEGIN SELECT user INTO v_username FROM dual; INSERT INTO ActivityLog (Username, Activity, TimeOf) VALUES (v_username, 'DELETION', SYSTIMESTAMP); END;");
            stmt.close();
        } catch (SQLException e) {
            System.out.println(EXCEPTION_TAG + " " + e.getMessage());
        }
